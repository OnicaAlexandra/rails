...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<i18n>.freeze, ["< 0.9", ">= 0.6.4"])
      s.add_runtime_dependency(%q<sixarm_ruby_unaccent>.freeze, ["< 2", ">= 1.1.1"])
      ...
      s.add_dependency(%q<i18n>.freeze, ["< 0.9", ">= 0.6.4"])
      s.add_dependency(%q<sixarm_ruby_unaccent>.freeze, ["< 2", ">= 1.1.1"])
